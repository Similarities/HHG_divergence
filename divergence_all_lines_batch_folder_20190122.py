...
class FwhmImageProcessing:
    ...
    def nm_in_px(self, wavelength_in):
        return int(4.38500909e-01 * wavelength_in ** 2 - 1.04443316e+02 * wavelength_in + 4.25826559e+03)
    ...
    def px_in_nm(self, px_number):
        return 1.15696112e-06 * px_number ** 2 - 1.63040125e-02 * px_number + 5.20764280e+01
...
my_files = get_file_list('rotated_20190122')
process_files(my_files, 'rotated_20190122')
