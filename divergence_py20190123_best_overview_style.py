...
class Open_and_Plot_Picture:
        ...
        def plot_diffraction_limit(self):
            ...
            for x in range(0, self.count_N -1):
                ...
                self.N_diffraction_limit[x] = C1 * ( ( (4 * math.pi * denting_constant) ** 2 + (self.lambdaL * 1E-9 / self.N_list[x] ) ** 2) ) ** 0.5
        ...
        def plot_result(self):
            ...
            plt.scatter(self.FWHM_for_N[::, 0], self.FWHM_for_N[::, 2], label = self.filedescription, linewidth = 0.2, marker = marker2)
...
Picture1=Open_and_Plot_Picture('rotated/spectro1__Wed Jan 23 2019_16.50.14_62.tif', 150, 1500, 807.5, 40,"20190123_62 z2400 GVD900")
Picture1.open_file()
Picture1.background()
...
Picture1=Open_and_Plot_Picture('rotated/spectro1__Wed Jan 23 2019_14.51.31_17.tif', 150, 1500, 813.5, 40,"20190123_17 z2000 GVD900")
Picture1.open_file()
Picture1.background()
Picture1.grating_function()
Picture1.N_borders_in_px()
...
Picture1=Open_and_Plot_Picture('rotated/spectro1__Wed Jan 23 2019_16.15.56_46.tif', 150, 1500, 807.5, 50,"20190123_46 z3600 GVD900")
Picture1.open_file()
Picture1.background()
Picture1.grating_function()
Picture1.N_borders_in_px()
...
Picture1=Open_and_Plot_Picture('rotated/spectro1__Wed Jan 23 2019_16.13.00_44.tif', 150, 1500, 807.5, 50,"20190123_44 z3200 GVD900")
Picture1.open_file()
Picture1.background()
Picture1.grating_function()
Picture1.N_borders_in_px()
...
Picture1=Open_and_Plot_Picture('rotated/spectro1__Wed Jan 23 2019_16.51.09_63.tif', 100, 1400, 808.5, 40,"20190123_63 z2000 GVD900")
Picture1.open_file()
Picture1.background()
Picture1.grating_function()
Picture1.N_borders_in_px()
...
Picture1=Open_and_Plot_Picture('rotated/spectro1__Wed Jan 23 2019_14.46.17_14.tif', 200, 1400, 812.5, 50,"20190123_14 z1600 GVD900")
Picture1.open_file()
Picture1.background()
Picture1.grating_function()
Picture1.N_borders_in_px()
